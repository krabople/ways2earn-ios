...
const Icon = ({
  ...
  name: keyof typeof tabSymbols;
  colour: ColorValue;
}) => (
  <SymbolView
    name={tabSymbols[name]}
    tintColor={colour}
    size={24}
    weight="semibold"
  />
  ...
  return (
    ...
    >
      <Tabs.Screen
        ...
        options={{
          title: "Discover",
          tabBarIcon: ({ color }) => <Icon name="discover" colour={color} />,
        }}
      />
      <Tabs.Screen
        name="community"
        options={{
          title: "Discuss",
          tabBarIcon: ({ color }) => <Icon name="discuss" colour={color} />,
        }}
      />
      <Tabs.Screen
        name="submit"
        options={{
          title: "Post",
          tabBarIcon: ({ color }) => <Icon name="post" colour={color} />,
        }}
      />
      <Tabs.Screen
        name="alerts"
        options={{
          title: "Alerts",
          tabBarBadge: feed?.unread || undefined,
          tabBarIcon: ({ color }) => <Icon name="alerts" colour={color} />,
        }}
      />
      <Tabs.Screen
        name="account"
        options={{
          title: "Account",
          tabBarIcon: ({ color }) => <Icon name="account" colour={color} />,
        }}
      />
    </Tabs>
  );
