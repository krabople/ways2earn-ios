...
export function ArticleSection({
  ...
  return (
    ...
    >
      <Text style={[styles.heading, tone === "navy" && styles.white]}>
        {title}
      </Text>
...
export function Paragraph({
  ...
  return (
    <Text style={[styles.paragraph, light && styles.light]}>{children}</Text>
  );
}
...
export function Bullet({
  ...
  return (
    <View style={styles.bulletRow}>
      <Text style={[styles.bullet, light && styles.light]}>•</Text>
      <Text
        style={[styles.paragraph, styles.bulletText, light && styles.light]}
      >
        {children}
      </Text>
    </View>
...
export function ArticleDoneButton() {
  return (
    <Pressable
      ...
      accessibilityLabel="Return to account"
      onPress={() => router.back()}
    >
